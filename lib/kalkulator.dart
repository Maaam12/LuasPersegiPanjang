...
class kalkulator extends StatefulWidget {
  const kalkulator({Key? key, required String title}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          child: Text( 
            "Hasil : ${ctrHasil.text}cm", style: TextStyle(fontSize: 15, fontWeight:FontWeight.bold, color: Colors.black,), 
